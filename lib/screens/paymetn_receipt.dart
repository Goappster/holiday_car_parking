...
class _PaymentReceiptState extends State<PaymentReceipt> {
  ...
  late var departureDate;
  late var returnDate;
  late var companyName;
  late var companyLogo;
  late var ReferenceNo;
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  leading: Image.asset('assets/images/purple.png'),
                ...
                ListTile(
                  title: Text('Drop-Off'),
                  trailing: Text(DateFormat('EEE dd MMM yyyy \'at\' hh:mm').format(departureDate), style: Theme.of(context).textTheme.labelLarge,),
                ),
                ListTile(
                  title: Text('Return'),
                  trailing:   Text(DateFormat('EEE dd MMM yyyy \'at\' hh:mm').format(returnDate), style: Theme.of(context).textTheme.labelLarge,),
                ),
                ListTile(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('$ReferenceNo', style: TextStyle(fontSize: 18)),
                    ],
                  ),
                ),
              ],
